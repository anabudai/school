package com.ana.datasource.config.customtypes;
...
public class LocalDateUserType implements EnhancedUserType, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1585839769214160502L;
	...
	public void nullSafeSet(PreparedStatement preparedStatement, Object value,
		...
		if (value == null) {
			...
			StandardBasicTypes.DATE.nullSafeSet(preparedStatement, time, index,
					session);
		}
	}
